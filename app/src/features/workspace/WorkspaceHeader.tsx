    ...
    <View style={styles.wrap}>
      ...
      {status === 'connected' && snapshot?.connectedSince && (
        <Text style={styles.statusLine}>
          CONNECTED · {formatUptime(snapshot.connectedSince)} · MQTT {profile.protocolVersion === 5 ? '5.0' : '3.1.1'}
        </Text>
      )}
...
const styles = StyleSheet.create({
  wrap: { borderBottomColor: colors.hairline, borderBottomWidth: 1, paddingBottom: space.sm },
  row: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: space.md, paddingTop: space.sm },
  backBtn: { padding: 4 },
  ...
  actionBtn: { borderColor: colors.hairline, borderWidth: 1, borderRadius: 9, paddingVertical: 6, paddingHorizontal: 11 },
  actionText: { fontSize: 12, fontWeight: '600', color: colors.accent },
  statusLine: { fontFamily: font.mono, fontSize: 10.5, color: colors.textTertiary, paddingHorizontal: space.md, paddingTop: 6 },
  faultBox: { marginHorizontal: space.md, marginTop: space.sm, backgroundColor: colors.faultDim, borderColor: colors.faultBorder, borderWidth: 1, borderRadius: 12, padding: 12, gap: 8 },
  ...
  faultBtn: { borderColor: 'rgba(255,176,32,0.4)', borderWidth: 1, borderRadius: 8, paddingVertical: 6, paddingHorizontal: 11 },
  faultBtnText: { fontSize: 12.5, fontWeight: '600', color: colors.fault },
  retryBtn: { borderColor: colors.hairline, borderWidth: 1, borderRadius: 8, paddingVertical: 6, paddingHorizontal: 11 },
  retryBtnText: { fontSize: 12.5, fontWeight: '600', color: colors.textSecondary },
});
